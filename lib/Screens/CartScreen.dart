...
class _CartScreenState extends State<CartScreen> {
  ...
  Widget build(BuildContext context) {
    List<product_cls> products = Provider.of<CartItem>(context).allproducts;
     ...
     ///Menghitung dimensi layar dan appBar untuk digunakan nanti
        ...
        children:[
          LayoutBuilder(builder: (context, constrains) {
            if (products.isNotEmpty) {
               ///Jika ada produk dalam keranjang, tampilkan daftar produk
              return Container(
                height: screenHeight -
                    statusBarHeight -
                    appBarHeight -
  ...
  void showCustomMenu(details, context, product) async {
     ///Menampilkan menu kustom ketika pengguna melakukan tap pada produk
        ...
        PopupMenuItem(
          onTap: () {
            Provider.of<CartItem>(context, listen: false)
                .deleteProduct(product); ///Menghapus produk dari keranjang
            setState(() {});
          },
          child: Text('Delete'), ///Opsi menu untuk menghapus produk
        ),
      ],
    );
  }
