...
class ApiConstants {
  ...
  /// Konstanta untuk URL API yang digunakan dalam aplikasi
}
...
class DioHelper {
  ...
  Future<List> getNews({required String path}) async {
    ...
    /// Class untuk melakukan permintaan HTTP menggunakan Dio
  }
}
...
class HomeScreen extends StatefulWidget {
  ...
  ///Halaman utama aplikasi yang berisi daftar produk
}
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    super.initState();
    getData();
    /// Memanggil metode getData() saat widget diinisialisasi
  }
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      theme: isDarkModeEnabled ? ThemeData.dark() : ThemeData.light(),
       /// Konfigurasi tema aplikasi tergantung pada mode gelap atau terang
      home: Scaffold(
        appBar: AppBar(
          backgroundColor: Colors.red,
          title: const Text('ShopApp'),
          actions: <Widget>[
            /// Tombol pencarian dan keranjang belanja dalam AppBar
            IconButton(
              icon: const Icon(
                Icons.search,
                color: Colors.white,
        ...
        body: Padding(
          ...
          child: Column(
            children: [
               /// Widget lain untuk judul "Trending" dan Carousel
              SizedBox(height: 10),
              Container(
                width: 360,
                height: 25,
                              ...
                              return GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                       /// Menampilkan gambar produk dan detailnya
                                      Expanded(
                                        child: Image.network(
                                          product[index].image,
                                          fit: BoxFit.cover,
